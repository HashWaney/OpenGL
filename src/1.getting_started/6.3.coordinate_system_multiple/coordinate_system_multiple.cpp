...
int main() {
    ...
    //load shader
    Shader shaderTool(
            "/Users/wangqing/Desktop/JNI/CPP/OpenGl/src/1.getting_started/6.3.coordinate_system_multiple/6.3.coordinate_systems.vs",
            "/Users/wangqing/Desktop/JNI/CPP/OpenGl/src/1.getting_started/6.3.coordinate_system_multiple/6.3.coordinate_systems.fs");
    //6个面 x 每个面有2个三角形组成 x 每个三角形有3个顶点 共需要36个顶点。
    //有些三角形会被绘制在其它三角形上面，虽然它们本不应该是被覆盖的，OpenGL存储深度信息在一个叫做Z缓冲(Z-buffer)的缓冲中，它允许OpenGL决定何时覆盖一个像素而何时不覆盖。通过使用Z缓冲，我们可以配置OpenGL来进行深度测试。
    // Z缓冲
...
//        glm::mat4 model = glm::mat4(1.0f);
        ...
        //xy平面进行旋转
//        model = glm::rotate(model, (float) glfwGetTime(), glm::vec3(0.5f, 1.0f, 0.f));
...
//        glUniformMatrix4fv(viewLoc, 1, GL_FALSE, &view[0][0]);
        ...
        for (unsigned int i = 1; i <= 10; i++) {
            ...
            model = glm::rotate(model,glm::radians(angle),glm::vec3(1.0f,0.4f,0.5f));
            shaderTool.setMat4("model",model);
...
int main2() {
    ...
    //
    Shader ourShader(
            "/Users/wangqing/Desktop/JNI/CPP/OpenGl/src/1.getting_started/6.2.coordinate_system_depth/6.3.coordinate_systems.vs",
            "/Users/wangqing/Desktop/JNI/CPP/OpenGl/src/1.getting_started/6.2.coordinate_system_depth/6.3.coordinate_systems.fs");
//
